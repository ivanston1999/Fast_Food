package com.android.fastfood.data.network.api.service

import com.android.fastfood.BuildConfig
...
interface FastFoodApiService {
    ...
    companion object {
        @JvmStatic
        operator fun invoke(chucker: ChuckerInterceptor): FastFoodApiService {
            ...
            val retrofit = Retrofit.Builder()
                ...
                .client(okHttpClient)
                .build()
            return retrofit.create(FastFoodApiService::class.java)
        }
    }
}